...
const routers = [
    ...
    },
    {
        ...
        component: resolve =>
            require(["../pages/order/AllAfterService"], resolve),
    ...
    },
    {
        path: "/datasetting",
        component: resolve =>
            require(["../pages/setting/DataSetting"], resolve),
        name: "DataSetting",
        meta: {
            navShow: true,
            tabShow: false,
    ...
    },
    {
        ...
        component: resolve =>
            require(["../pages/order/AfterSalesDetail"], resolve),
    ...
    },
    {
        path: "/balancelist",
        component: resolve =>
            require(["../pages/balance/BalanceList"], resolve),
        name: "BalanceList",
        meta: {
            navShow: true,
            tabShow: false,
    ...
    },
    {
        path: "/withdrawcash",
        component: resolve =>
            require(["../pages/balance/WithDrawCash"], resolve),
        name: "WithDrawCash",
        meta: {
            navShow: true,
            tabshow: false,
    ...
    },
    {
        path: "/mybankcardlist",
        component: resolve =>
            require(["../pages/balance/MyBankCardList"], resolve),
        name: "MyBankCardList",
        meta: {
            navShow: true,
            tabShow: false,
    ...
    },
    {
        path: "/recommendlist",
        component: resolve =>
            require(["../pages/share/RecommendList"], resolve),
        name: "RecommendList",
        meta: {
            navShow: true,
            tabShow: false,
    ...
    },
    {
        path: "/articlelist",
        component: resolve =>
            require(["../pages/article/ArticleList"], resolve),
        name: "ArticleList",
        meta: {
            navShow: true,
            tabShow: false,
    ...
    },
    {
        ...
        component: resolve =>
            require(["../pages/store/OrderVerification"], resolve),
    ...
    },
    {
        path: "/seckilldetail",
        component: resolve =>
            require(["../pages/activity/SecKilldetail"], resolve),
        name: "SecKillDetail",
        meta: {
            navShow: false,
            tabShow: false,
    ...
    },
    {
        path: "/groupbuying",
        component: resolve =>
            require(["../pages/activity/GroupBuying"], resolve),
        name: "GroupBuying",
        meta: {
            navShow: false,
            tabShow: false,
